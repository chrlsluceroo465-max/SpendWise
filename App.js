...
const styles = StyleSheet.create({
  ...
  categoryIconPlaceholder: { width: 40, height: 40, borderRadius: 12, backgroundColor: '#F1F5F9', alignItems: 'center', justifyContent: 'center', marginRight: 12 },
  categoryLetter: { fontSize: 16, fontWeight: '700', color: '#475569' },
